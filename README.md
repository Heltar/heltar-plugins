...
- All 12 [Heltar skills](./plugins/heltar-claude-plugin/skills/) — authentication, messaging, templates, campaigns, chatbots, webhooks, contacts, calls, groups, code-editor, schedule, web-widget. Bundled into the plugin at publish time so the install is self-contained.
