...
- All 16 [Heltar skills](./plugins/heltar-claude-plugin/skills/) — authentication, messaging, templates, campaigns, chatbots, webhooks, contacts, calls, groups, code-editor, schedule, web-widget, business (account status, opt-in/opt-out rules), team, analytics, link-tracker. Bundled into the plugin at publish time so the install is self-contained.
