...
Heltar skills available in this plugin:
  ...
  heltar-web-widget      — Embed the web chat widget on your site; visitors land in the same inbox.
  heltar-business        — Account status / quality rating, opt-in & opt-out keyword rules, business settings.
  heltar-team            — Team members, roles & permissions, multi-business access, auto chat assignment.
  heltar-analytics       — Engagement, conversation, template and cost analytics.
  heltar-link-tracker    — Create short, trackable links and list them.

What do you want to do? (e.g. "send a template to 500 customers", "wire up webhooks", "check my account status", "set STOP as an opt-out keyword")
```
